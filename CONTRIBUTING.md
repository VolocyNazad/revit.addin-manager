...
when the development policy requires it. Run the repository build, the tests
and the policy validator before submitting a pull request:

```powershell
dotnet test Revit.AddinManager.slnx
